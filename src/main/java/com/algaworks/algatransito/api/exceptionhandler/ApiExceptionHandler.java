...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers,
        ...
        problemDetails.setType(URI.create("https://algatransito.com/erros/campos-invalidos"));
    ...
    public ProblemDetail handleNegocioException(NegocioException e) {
        ...
        problemDetail.setType(URI.create("https://algatransito.com/erros/regra-de-negocio-violada"));
    ...
    public ProblemDetail handleEntidadeNaoEncontrada(NegocioException e) {
        ...
        problemDetail.setTitle(e.getMessage());
        problemDetail.setType(URI.create("https://algatransito.com/erros/recurso-nao-encontrada"));
        return problemDetail;
    }
